                        ...
                        IN ULONG Protect)
{
    ...
    //
    // This is a specific Windivs check because we only use normal VADs
    //
                    ...
                    IN ULONG FreeType)
{
    ...
    //
    // Finally, make sure there is a Windivs Mm MEMORY_AREA for this allocation
        ...
        else
        {
            ...
            if ((StartingAddress >> PAGE_SHIFT) == Vad->StartingVpn)
            {
                ...
                else
                {
                    ...
                    // For Windivs: shrink the corresponding memory area
            ...
            else
            {
                ...
                else
                {
                    ...
                    // Windivs: This will take care of creating a second MEMORY_AREA.
                    //
