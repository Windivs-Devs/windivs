...
//
// By default, it is a 16MB region, but we hack it to be 32MB for Windivs
//
...
//
// Unlike the old Windivs Memory Manager, ARM³ (and Windows) does not keep track
...
MiBuildPagedPool(VOID)
{
    ...
    // page directory array in the old Windivs Mm is used (but in a less hacky
    // way).
    //
