...
Windivs™ is an Open Source effort to develop a quality operating system that is
...
Windivs has always intended to work with the WINE project to share as much
...
The Windivs project, although currently focused on Windows Server 2003
...
The Windows NT architecture allows for subsystems, as does the Windivs
architecture. A subsystem is an implementation of the APIs of another
operating system, allowing Windivs to run applications from other systems.
...
Yes we are.
All the code of Windivs has been written from scratch by our developers.
...
Windivs - amongst other topics. Contributors to the project are always welcome.
...
In addition, the Windivs forum: https://reactos.org/forum
