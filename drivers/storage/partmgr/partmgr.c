...
/* The Partition Manager Driver in Windivs complements disk.sys/classpnp.sys drivers
 ...
 * exist in Windivs. Thus handles some IOCTL_VOLUME_*, and IOCTL_MOUNTMGR_* IOCTLs.
 */
