/*
 * PROJECT:     Windivs Console Text-Mode Device Driver
...
/*
 * (Adapted for Windivs/Win2k3 from an original comment
 ...
 *
 * In Windivs things are a little bit different. We want to have a functional
