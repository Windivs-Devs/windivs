...

{
    ...
    COMPOUND_PATH_ENTRY CompoundPathEntry = {{0}};/* Windivs Change: GCC "missing braces around initializer" */
    ...
    try_exit:  NOTHING;
        ...
        if (CleanupFileLookup) {
            ...
            CdCleanupDirent( IrpContext, &Dirent );/* Windivs Change: GCC "passing argument 1 from incompatible pointer type" */
