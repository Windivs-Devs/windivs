...
static /* Windivs Change: GCC "multiple definition" */
...
#define CdFreeIoContext(IO)     CdFreePool( (PVOID) &(IO) ) /* Windivs Change: GCC "passing argument 1 from incompatible pointer type" */
...
//
/* Windivs Change: GCC "passing argument 1 of CdFreePool from incompatible pointer type" */
