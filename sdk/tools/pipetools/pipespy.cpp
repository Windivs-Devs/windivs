 ...
 * Released under the GNU GPL for the Windivs project
 *
 * This program can be used to spy on a named pipe in Windows NT(+)
 * or Windivs.  It is particularly intended to be used for
 ...
 * NOTE:
 *
 * This program hasn't really been tested against Windivs, and has only
