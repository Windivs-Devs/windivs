...
Language=English
\n\nWindivs is free software, covered by the GNU General Public License,
 and you\n are welcome to change it and/or distribute copies of it under
 certain\n conditions. There is absolutely no warranty for Windivs.\n
.
...
Language=English
A problem has been detected and Windivs has been shut down to prevent damage
to your computer.
.
...
for any Windivs updates you might need.
...
Language=English
A system file that is owned by Windivs was replaced by an application
...
has prevented Windivs from operating.  You can determine which component is
...
hardware problem thereby allowing Windivs to operate.
.
