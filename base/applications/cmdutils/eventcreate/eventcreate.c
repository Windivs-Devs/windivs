 ...
 *    large file.
 *
 *    For Windivs I want to have a compromise between disk space and usage
 ...
 *
 * Windivs' EventCreate.exe command uses the same limits as Powershell.
 */
    ...
    IN LPCWSTR EventLogSource)
{
     ...
     * - In case of success, try to replace the Windivs installation path
...
int wmain(int argc, WCHAR* argv[])
{
    ...
    OPTION Options[] =
    {
        ...
        /* Event category (Windivs additional option) */
