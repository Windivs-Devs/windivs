        ...
        case WM_COMMAND:
        {
            switch (LOWORD(wParam))
            {
                ...
                case IDC_BTN_BROWSE_ALL_FILES:
                {
                    ...
                    ofn.hwndOwner   = hDlg;
                    ofn.lpstrTitle  = L"Files to be restored"; // L"Fichiers � restaurer"; // FIXME: Localize!
                ...
                case IDC_BTN_BROWSE_DIRS:
                {
                    ...
                    bi.lpszTitle = L"Select the directory where the restored files should be stored:";
                                // L"Choisissez le r�pertoire dans lequel doivent �tre enregistr�s les fichiers restaur�s :"; // FIXME: Localize!
