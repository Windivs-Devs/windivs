...
InitLogs()
{
    ...
    if (key.Create(
            HKEY_LOCAL_MACHINE,
            L"SYSTEM\\CurrentControlSet\\Services\\EventLog\\Application\\Windivs Application Manager", REG_NONE,
    ...
    {
        hLog = RegisterEventSourceW(NULL, L"Windivs Application Manager");
    }
}
