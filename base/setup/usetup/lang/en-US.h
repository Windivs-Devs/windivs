...
static MUI_ENTRY enUSWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "This part of the setup copies the Windivs7 Operating System to your",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
     ...
     // "\x07  Press R to repair a Windivs7 installation using the Recovery Console.",
        "\x07  Press R to repair a Windivs7 installation.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Press L to view the Windivs7 Licensing Terms and Conditions.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        23,
        "For more information on Windivs7, please visit:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
