...
{
    {
        4,
        3,
        " Instala\207\306o do WIndivs7 Beta 2 (7201) ",
    ...
    },
    {
        0,
        20,
        "Por favor aguarde enquanto o Instalador do Windivs7 inicializa",
...
static MUI_ENTRY ptPTWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bem-vindo ao assist\210nte de instala\207\306o do Windivs7.",
    ...
    },
    {
        6,
        11,
        "Esta fase da instala\207\306o prepara o Windivs7 para ser",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Pressione ENTER para instalar ou actualizar o Windivs7.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
        "\x07  Para reparar uma instala\207\306o do Windivs7, pressione R.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        21,
        "\x07  Para sair sem instalar o Windivs7, pressione F3.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Para mais informa\207\344es sobre o Windivs7, visite o s\241tio:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "O Windivs7 est\240 em est\240gio Alpha, o que significa que n\306o est\240 completo",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "secund\240rio se pretende executar o Windivs7 em hardware real.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Pressione ENTER para continuar a instala\207\306o do Windivs7.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Pressione F3 para terminar sem instalar o Windivs7.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "O Windivs7 est\240 licenciado sob os termos da licen\207a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Todo o software que faz parte do sistema Windivs7 \202 portanto,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "A licen\207a do Windivs7 abrange apenas a distribui\207\306o a terceiros.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License com o Windivs7 por favor visite",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "O instalador do Windivs7 est\240 em fase inicial de desenvolvimento e",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Com o Instalador do Windivs7 pode actualizar uma das instala\207\344es",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "dispon\241veis listadas abaixo, ou, se tem uma instala\207\306o do Windivs7",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "O Windivs7 n\306o foi totalmente instalado neste computador.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Os componentes b\240sicos do Windivs7 foram instalados com sucesso.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Para configurar o Windivs7 no item seleccionado, pressione ENTER.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "formato n\306o suportado pelo Windivs7.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Para instalar o Windivs7 com sucesso, o instalador deve alterar",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "ap\242s a instala\207\306o do Windivs7 ser concluida.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "(Windivs7) ou outro e programas fornecidos pelo fabricante do hardware.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "computador pelo disco r\241gido at\202 concluir a instala\207\306o do Windivs7.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "Seleccione o direct\242rio onde deseja que o Windivs7 seja instalado:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "o texto e escreva o nome do direct\242rio onde deseja que o Windivs7",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTFileCopyEntries[] =
{
    ...
    },
    {
        0,
        13,
        "ficheiros do Windivs7 para a pasta de instala\207\306o.",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR ptPTErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "O Windivs7 n\306o est\240 completamente instalado no computador.\n"
        "Se sair da instala\207\306o agora, precisar\240 executa-la\n"
        "novamente para instalar o Windivs7.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Falha ao criar os caminhos para o direct\242rio de instala\207\306o do Windivs7!\n"
    ...
    {
        // ERROR_SOURCE_DIR
        "N\306o pode instalar o Windivs7 dentro do direct\242rio de origem da instala\207\306o!\n"
        "ENTER = Reiniciar o computador"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "A parti\207\306o selecionada n\306o \202 grande o suficiente para instalar o Windivs7.\n"
...
//    "Voc\210 solicitou a cria\207\306o de uma nova parti\207\306o em"},
    ...
    "Solicitou instalar o Windivs7 numa parti\207\306o nova ou sem formato."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "A parti\207\306o ainda n\306o est\240 formatada."},
    {STRING_NONFORMATTEDOTHERPART,
    "A nova parti\207\306o ainda n\306o est\240 formatada."},
    {STRING_INSTALLONPART,
    "O instalador instala o Windivs7 na parti\207\306o"},
    {STRING_CONTINUE,
    "ENTER=Continuar"},
    {STRING_QUITCONTINUE,
    "F3=Sair  ENTER=Continuar"},
