...
static MUI_ENTRY skSKChangelogPageEntries[] =
    {
        {
            4,
            3,
...
{
    {
        4,
        3,
        " In\347tal\240tor syst\202mu Windivs7 RTM (build 7600) ",
        TEXT_STYLE_UNDERLINE,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR skSKErrorEntries[] =
{
    ...
    },
    {
        ...
        "Setup found an invalid signature in TXTSETUP.SIF.\n", //chybn� (neplatn�) podpis (znak, zna\237ka, \347ifra)
        "ENTER = Re\347tart po\237\241ta\237a"
    },
    {
...
//          "In\347tal�tor zistil, �e najmenej jeden pevn� disk obsahuje nekompatibiln�\n"
