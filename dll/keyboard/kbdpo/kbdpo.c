...
ROSDATA VSC_VK extcode0_to_vk[] = {
  ...
  { 0x32, VK_BROWSER_HOME        | KBDEXT },	// Pagina predefinida do navegador de internet, ou abri-lo se n�o estiver activo
  ...
  { 0x68, VK_BROWSER_STOP        | KBDEXT },	// Parar navega��o na internet internet
...
ROSDATA VK_TO_WCHARS2 key_to_chars_2mod[] = {
  ...
  { ORDERN_SUPERSCRIPT,	0, {       0xBA,       0xAA} }, // � �
  { MATH_RELATE,	0, {        '<',        '>'} },
  { VK_OEM_COMMA,	0, {        ',',        ';'} },
  { VK_OEM_PERIOD,	0, {        '.',        ':'} },
  { VK_OEM_MINUS,	0, {        '-',        '_'} },
