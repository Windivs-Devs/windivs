...
InitializeFmIfsOnce(VOID)
{
    ...
    UNICODE_STRING RegistryPath
        = RTL_CONSTANT_STRING(L"\\REGISTRY\\Machine\\SOFTWARE\\Windivs\\Windivs\\CurrentVersion\\IFS");
    HANDLE hKey = NULL;
    ...
    /* Read IFS providers from HKLM\SOFTWARE\Windivs\Windivs\CurrentVersion\IFS */
