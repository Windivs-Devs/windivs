...
typedef struct
{
    ...
    HBITMAP   hBmpClose; /* Windivs modification */
} MDICLIENTINFO;
...
#ifdef __REACTOS__
	PostMessageA( hwnd, WM_MDICALCCHILDSCROLL, 0, 0 ); //// Windivs: Post not send!
#else
...
void WINAPI CalcChildScroll( HWND hwnd, INT scroll )
{
    ...
    *
    * Apparently (in Windivs at least) the rcClient returned by GetWindowInfo
