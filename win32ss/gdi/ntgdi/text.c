...
/*
   ...
   It is needed because Windivs does not support raster fonts now.
   After Raster Font support is added, then it can be removed.
   Find the current font's logfont for testing its lf.lfFaceName.

   The ftGdiGetTextMetricsW function currently in Windivs will always return a Truetype font
