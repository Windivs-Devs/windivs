 ...
 *                  V�ctor Mart�nez Calvo <vmartinez@reactos.org>
 */
...
} Tests[] =
{
    ...
    { L"C:\\Windivs\\**",       L"C:\\Windivs\\dings.bmp",      FALSE,  FALSE,  TRUE },
    { L"C:\\Windivs\\***",      L"C:\\Windivs\\dings.bmp",      FALSE,  FALSE,  TRUE },
    { L"C:\\Windows\\*a*",      L"C:\\Windivs\\dings.bmp",      FALSE,  FALSE,  FALSE },
    { L"C:\\Windivs\\*.bmp",    L"C:\\Windows\\explorer.exe",   FALSE,  FALSE,  FALSE },
