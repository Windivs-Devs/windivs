/* Console Task Manager
   ...
   Windivs Task Manager written by Brian Palmer (brianp@reactos.org)

   Localization features added by Herv� Poussineau (hpoussin@reactos.org)

   History:
    24 October 2004 - added localization features
	09 April 2003 - v0.1, fixed bugs, added features, ported to mingw
   	20 March 2003 - v0.03, works good under Windivs, and allows process
			killing
